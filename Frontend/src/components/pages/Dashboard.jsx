...
import { Activity, TrendingUp, History, MessageSquare, Send, BarChart3, Calendar, FileText, X, Eye } from "lucide-react";
      ...
      <div className="space-y-6">
        {lines.map((line, index) => {
          ...
          if (line.match(/^\d+\.\s+[A-Z]/)) {
            return (
              <h4 key={index} className="text-lg font-medium text-emerald-700 mt-4 mb-2">
                {line}
              </h4>
            );
          }
    ...
    <div className="min-h-screen bg-gradient-to-br from-emerald-50 via-teal-50 to-cyan-50">
      ...
      {showTermsModal && !termsAccepted && (
        <div className="fixed inset-0 bg-black bg-opacity-60 flex items-center justify-center z-50 p-4">
          <div className="bg-white rounded-3xl shadow-2xl max-w-3xl w-full max-h-[90vh] overflow-hidden animate-fade-in">
            {/* Modal Header */}
            <div className="bg-gradient-to-r from-emerald-500 to-teal-600 p-8 text-white">
              <div className="flex items-center space-x-3 mb-2">
                ...
                <div>
                  <h2 className="text-3xl font-bold">Welcome to DietAnalyzer</h2>
                  <p className="text-emerald-100 text-sm mt-1">AI-Powered Nutrition Analysis Platform</p>
                </div>
              </div>
            </div>
            ...
            <div className="p-8 overflow-y-auto max-h-[calc(90vh-280px)]">
              <div className="prose max-w-none">
                ...
                <div className="space-y-6 text-gray-700">
                  <section>
                    <h4 className="text-lg font-semibold text-emerald-700 mb-2">1. Acceptance of Terms</h4>
                    <p className="leading-relaxed">
                      By accessing and using DietAnalyzer, you acknowledge that you have read, understood, and agree to be bound by these Terms and Conditions. If you do not agree to these terms, please do not use this service.
                    </p>
                  </section>

                  <section>
                    <h4 className="text-lg font-semibold text-emerald-700 mb-2">2. Medical Disclaimer</h4>
                    <p className="leading-relaxed">
                      DietAnalyzer provides AI-generated nutritional analysis and recommendations for informational purposes only. This service is <strong>not a substitute for professional medical advice, diagnosis, or treatment</strong>. Always consult with qualified healthcare professionals before making any dietary changes, especially if you have existing health conditions.
                    </p>
                  </section>

                  <section>
                    <h4 className="text-lg font-semibold text-emerald-700 mb-2">3. Use of Service</h4>
                    <p className="leading-relaxed">
                      You agree to use DietAnalyzer responsibly and for lawful purposes only. You must provide accurate information when using the diet analysis features. The AI assistant is designed to provide general nutritional guidance and should not be relied upon for critical health decisions.
                    </p>
                  </section>

                  <section>
                    <h4 className="text-lg font-semibold text-emerald-700 mb-2">4. Data Privacy</h4>
                    <p className="leading-relaxed">
                      We respect your privacy and are committed to protecting your personal information. Your diet data and analysis history are stored securely and used solely to provide and improve our services. We do not share your personal health information with third parties without your explicit consent.
                    </p>
                  </section>

                  <section>
                    <h4 className="text-lg font-semibold text-emerald-700 mb-2">5. AI-Generated Content</h4>
                    <p className="leading-relaxed">
                      The nutritional analysis and recommendations provided by DietAnalyzer are generated by artificial intelligence created by <strong>Dipayan Dey</strong>. While we strive for accuracy, AI-generated content may contain errors or be based on generalized information that may not apply to your specific circumstances.
                    </p>
                  </section>

                  <section>
                    <h4 className="text-lg font-semibold text-emerald-700 mb-2">6. Limitation of Liability</h4>
                    <p className="leading-relaxed">
                      DietAnalyzer and its creators shall not be liable for any direct, indirect, incidental, consequential, or special damages arising from your use of this service or reliance on the information provided. Use this service at your own risk.
                    </p>
                  </section>

                  <section>
                    <h4 className="text-lg font-semibold text-emerald-700 mb-2">7. Modifications to Terms</h4>
                    <p className="leading-relaxed">
                      We reserve the right to modify these Terms and Conditions at any time. Continued use of the service after changes constitutes acceptance of the modified terms.
                    </p>
                  </section>

                  <section>
                    <h4 className="text-lg font-semibold text-emerald-700 mb-2">8. Contact Information</h4>
                    <p className="leading-relaxed">
                      For questions or concerns about these terms or the service, please contact the developer: <strong>Dipayan Dey</strong>.
                    </p>
                  </section>
                </div>
                ...
                <div className="mt-8 p-6 bg-amber-50 border-l-4 border-amber-500 rounded-lg">
                  ...
                  <p className="text-amber-700 text-sm leading-relaxed">
                    This platform is designed to assist with general nutritional guidance. For personalized medical advice, please consult with licensed healthcare professionals, registered dietitians, or nutritionists.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="border-t border-gray-200 p-6 bg-gray-50">
              <div className="flex items-start space-x-3 mb-4">
                ...
                <label htmlFor="terms-checkbox" className="text-sm text-gray-700 cursor-pointer">
                  I have read and agree to the Terms & Conditions. I understand that this service provides AI-generated nutritional guidance and is not a substitute for professional medical advice.
                </label>
              </div>
              <button
        ...
        <div className="max-w-7xl mx-auto px-6 py-6">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="bg-white rounded-2xl shadow-md p-6 border border-emerald-100">
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-sm text-gray-500 font-medium">Total Diets Submitted</p>
                  <p className="text-3xl font-bold text-emerald-600 mt-2">{stats.total_diets_submitted || 0}</p>
                </div>
            ...
            <div className="bg-white rounded-2xl shadow-md p-6 border border-teal-100">
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-sm text-gray-500 font-medium">Total Analyses Generated</p>
                  <p className="text-3xl font-bold text-teal-600 mt-2">{stats.total_analyses_generated || 0}</p>
                </div>
      ...
      <div className="max-w-7xl mx-auto px-6 pb-12">
        ...
        {activeTab === "analyzer" && (
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            ...
            <div className="bg-white rounded-2xl shadow-md p-8 border border-emerald-100">
              <h2 className="text-2xl font-bold text-gray-800 mb-2">Analyze Your Diet</h2>
              <p className="mb-6">Here you can enter your disease — what you are suffering from. AI will help you understand how to live a better life with that condition, based on the information you provide in the chat.</p>
              ...
              {analysisResult ? (
                ...
                <div className="h-full flex items-center justify-center text-center">
                  <div>
                    ...
                    <p className="text-gray-400 text-sm mt-2">Fill in the form and click Analyze Diet</p>
                  </div>
                </div>
              )}
            </div>
        ...
        {activeTab === "chat" && (
          <div className="bg-white rounded-2xl shadow-md border border-emerald-100 h-[600px] flex flex-col">
            <div className="p-6 border-b border-gray-100">
              ...
              <p className="text-gray-500 mt-1">Ask me anything about nutrition, meal planning, and healthy eating</p>
            </div>
              ...
              {chatHistory.length === 0 ? (
                <div className="h-full flex items-center justify-center text-center">
                  <div className="max-w-md">
                    ...
                    <p className="text-gray-500 text-lg mb-4">Initializing AI Assistant...</p>
                  </div>
                </div>
              ) : (
        ...
        {activeTab === "history" && (
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            {/* Diet History */}
            <div className="bg-white rounded-2xl shadow-md p-8 border border-emerald-100">
              <h2 className="text-2xl font-bold text-gray-800 mb-6">Diet History</h2>
              
              {historyLoading ? (
                <div className="text-center py-12">
                  <svg className="animate-spin h-8 w-8 text-emerald-500 mx-auto" viewBox="0 0 24 24">
                    <circle className="opacity-25" cx="12" cy="12" r="10" stroke="currentColor" strokeWidth="4" fill="none" />
                    <path className="opacity-75" fill="currentColor" d="M4 12a8 8 0 018-8V0C5.373 0 0 5.373 0 12h4zm2 5.291A7.962 7.962 0 014 12H0c0 3.042 1.135 5.824 3 7.938l3-2.647z" />
                  </svg>
                </div>
                ...
                <div className="text-center py-12">
                  ...
                  <p className="text-gray-400 text-sm mt-1">Start analyzing your diet to see history</p>
                </div>
              ) : (
                <div className="space-y-4 max-h-[500px] overflow-y-auto">
                  {dietHistory.map((item) => (
                    <div key={item._id} className="border border-gray-200 rounded-xl p-5 hover:shadow-md transition-all">
                      <div className="flex items-start justify-between mb-3">
                        <div className="flex-1">
                          ...
                          <p className="text-gray-700 text-sm leading-relaxed mt-2">{item.diet_text}</p>
                        </div>
                      </div>
            ...
            <div className="bg-white rounded-2xl shadow-md p-8 border border-emerald-100">
              ...
              {historyLoading ? (
                ...
                <div className="text-center py-12">
                  ...
                  <p className="text-gray-400 text-sm mt-1">Your analyses will appear here</p>
                </div>
              ) : (
                <div className="space-y-4 max-h-[500px] overflow-y-auto">
                  {analysisHistory.map((item) => (
                    <div key={item._id} className="border border-gray-200 rounded-xl p-5 hover:shadow-md transition-all">
                      <div className="flex items-start justify-between mb-3">
                        <div className="flex-1">
                          <p className="font-semibold text-gray-800 mb-2">Analysis Report</p>
                          <p className="text-sm text-gray-600 line-clamp-3">{cleanText(item.analysis)?.substring(0, 150)}...</p>
                        </div>
                      </div>
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
          <div className="bg-white rounded-2xl shadow-2xl max-w-4xl w-full max-h-[90vh] overflow-hidden">
            ...
            <div className="bg-gradient-to-r from-emerald-500 to-teal-600 p-6 text-white">
              <div className="flex items-center justify-between">
                <div>
                  <h2 className="text-2xl font-bold">Full Analysis Report</h2>
